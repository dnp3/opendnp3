...
namespace opendnp3 { class IChannel; class DNP3Channel; class DNP3Manager; }

namespace openpal { class IPhysicalLayerAsync; }

namespace asiopal { class EventLog; class IOServiceThreadPool; }
