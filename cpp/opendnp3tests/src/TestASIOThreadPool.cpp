...
{
	EventLog log;
	IOServiceThreadPool pool(Logger(&log, levels::INFO, "pool"), 4);
}
...
{
	EventLog log;
	IOServiceThreadPool pool(Logger(&log, levels::INFO, "pool"), 8);
...
{
	EventLog log;
	IOServiceThreadPool pool(Logger(&log, levels::INFO, "pool"), 1);
