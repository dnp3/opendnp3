...
{
	TestObject test;
	BOOST_REQUIRE_EQUAL(CommandStatus::CLOSED, test.monitor.GetState());
...
BOOST_AUTO_TEST_CASE(StateClosedCanBeStopped)
{
	...
	BOOST_REQUIRE_EQUAL(CommandStatus::SHUTDOWN, test.monitor.GetState());
}
...
BOOST_AUTO_TEST_CASE(StartOneBeginsOpening)
{
	...
	BOOST_REQUIRE_EQUAL(CommandStatus::OPENING, test.monitor.GetState());
}
...
BOOST_AUTO_TEST_CASE(StartingWhileOpeningOneWillRetry)
{
	...
	test.monitor.Start();
	test.phys.SignalOpenFailure();
	BOOST_REQUIRE_EQUAL(CommandStatus::WAITING, test.monitor.GetState());
}
...
BOOST_AUTO_TEST_CASE(LayerCloseAfterStartOneDoesNotRetry)
{
	...
	BOOST_REQUIRE_EQUAL(CommandStatus::OPEN, test.monitor.GetState());
