...
struct Group121Var1
{
  ...
  static bool Read(ser4cpp::rseq_t&, Group121Var1&);
  static bool Write(const Group121Var1&, ser4cpp::wseq_t&);
  ...
  static bool ReadTarget(ser4cpp::rseq_t&, SecurityStat&);
  static bool WriteTarget(const SecurityStat&, ser4cpp::wseq_t&);
