...
private:
	...
	const std::chrono::steady_clock::duration mMinOpenRetry;
	const std::chrono::steady_clock::duration mMaxOpenRetry;

	std::chrono::steady_clock::duration mCurrentRetry;
