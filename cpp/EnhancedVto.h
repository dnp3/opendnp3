...
public:
	...
	static VtoData CreateVtoData(bool aLocalVtoConnectionOpened, uint8_t aChannelId);

	/** Throws an exception if the frame is not an enhanced vto control frame */
	static void ReadVtoData(const VtoData& arData, bool& arLocalVtoConnectionOpened, uint8_t& arChannelId);
