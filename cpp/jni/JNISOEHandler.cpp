...
namespace jni
{
    namespace cache
    {
        bool SOEHandler::init(JNIEnv* env)
        {
            ...
            this->processTAIMethod = env->GetMethodID(this->clazz, "processTAI", "(Lcom/automatak/dnp3/HeaderInfo;Ljava/lang/Iterable;)V");
            if(!this->processTAIMethod) return false;
        ...
        void SOEHandler::processTAI(JNIEnv* env, jobject instance, jobject arg0, jobject arg1)
        {
            env->CallVoidMethod(instance, this->processTAIMethod, arg0, arg1);
        }
