...
public:
     ...
     */
    virtual void Scan(const std::vector<opendnp3::Header>& headers,
                      const opendnp3::TaskConfig& config = opendnp3::TaskConfig::Default())
        = 0;
     ...
     */
    virtual void ScanAllObjects(opendnp3::GroupVariationID gvId,
                                const opendnp3::TaskConfig& config = opendnp3::TaskConfig::Default())
        = 0;
     ...
     */
    virtual void ScanClasses(const opendnp3::ClassField& field,
                             const opendnp3::TaskConfig& config = opendnp3::TaskConfig::Default())
        = 0;
    /**
    ...
    virtual void Restart(opendnp3::RestartType op,
                         ...
                         opendnp3::TaskConfig config = opendnp3::TaskConfig::Default())
        = 0;
