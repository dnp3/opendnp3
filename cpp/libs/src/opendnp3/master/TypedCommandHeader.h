...
template<class T> bool TypedCommandHeader<T>::Write(HeaderWriter& writer, IndexQualifierMode mode)
{
    ...
    {
        auto iter = writer.IterateOverCountWithPrefix<openpal::UInt8, T>(QualifierCode::UINT8_CNT_UINT8_INDEX,
                                                                         this->serializer);
    ...
    {
        auto iter = writer.IterateOverCountWithPrefix<openpal::UInt16, T>(QualifierCode::UINT16_CNT_UINT16_INDEX,
                                                                          this->serializer);
