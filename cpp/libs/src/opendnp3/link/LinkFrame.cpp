...
RSlice LinkFrame::FormatNotSupported(
    WSlice& buffer, bool aIsMaster, bool aIsRcvBuffFull, uint16_t aDest, uint16_t aSrc, openpal::Logger* pLogger)
{
...
RSlice LinkFrame::FormatResetLinkStates(
    WSlice& buffer, bool aIsMaster, uint16_t aDest, uint16_t aSrc, openpal::Logger* pLogger)
{
    return FormatHeader(buffer, 0, aIsMaster, false, false, LinkFunction::PRI_RESET_LINK_STATES, aDest, aSrc, pLogger);
}

RSlice LinkFrame::FormatRequestLinkStatus(
    WSlice& buffer, bool aIsMaster, uint16_t aDest, uint16_t aSrc, openpal::Logger* pLogger)
{
...
RSlice LinkFrame::FormatTestLinkStatus(
    WSlice& buffer, bool aIsMaster, bool aFcb, uint16_t aDest, uint16_t aSrc, openpal::Logger* pLogger)
{
    return FormatHeader(buffer, 0, aIsMaster, aFcb, true, LinkFunction::PRI_TEST_LINK_STATES, aDest, aSrc, pLogger);
}

RSlice LinkFrame::FormatConfirmedUserData(WSlice& buffer,
                                          bool aIsMaster,
                                          bool aFcb,
                                          uint16_t aDest,
                                          uint16_t aSrc,
...
RSlice LinkFrame::FormatUnconfirmedUserData(WSlice& buffer,
                                            bool aIsMaster,
                                            uint16_t aDest,
                                            uint16_t aSrc,
                                            const uint8_t* apData,
...
RSlice LinkFrame::FormatHeader(WSlice& buffer,
                               uint8_t aDataLength,
                               bool aIsMaster,
                               bool aFcb,
                               bool aFcvDfc,
