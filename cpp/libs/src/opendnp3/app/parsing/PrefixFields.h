...
{
public:
    template<typename... Args> static bool Read(openpal::RSlice& input, Args&... fields)
    {
    ...
    template<typename... Args> static bool Write(openpal::WSlice& dest, const Args&... fields)
    {
    ...
    template<typename... Args> static bool LengthFitsInUInt16(const openpal::RSlice& arg1, Args&... fields)
    {
        return (arg1.Size() <= openpal::MaxValue<uint16_t>()) && LengthFitsInUInt16(fields...);
    }

private:
    template<typename... Args> static uint32_t SumSizes(const openpal::RSlice& arg1, Args&... fields)
    {
