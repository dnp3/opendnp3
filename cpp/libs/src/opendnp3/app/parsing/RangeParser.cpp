...
ParseResult RangeParser::ParseHeader(openpal::RSlice& buffer,
                                     ...
                                     IAPDUHandler* pHandler)
{
    ...
    FORMAT_LOGGER_BLOCK(pLogger, settings.Filters(), "%03u,%03u %s, %s [%u, %u]", record.group, record.variation,
...
ParseResult RangeParser::ParseRangeOfObjects(openpal::RSlice& buffer,
                                             const HeaderRecord& record,
                                             const Range& range,
                                             openpal::Logger* pLogger,
                                             IAPDUHandler* pHandler)
...
ParseResult RangeParser::ParseRangeOfOctetData(openpal::RSlice& buffer,
                                               const HeaderRecord& record,
                                               const Range& range,
                                               openpal::Logger* pLogger,
                                               IAPDUHandler* pHandler)
