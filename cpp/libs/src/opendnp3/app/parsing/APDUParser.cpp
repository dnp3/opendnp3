...
ParseResult APDUParser::Parse(const openpal::RSlice& buffer,
...
ParseResult APDUParser::ParseSinglePass(const openpal::RSlice& buffer,
                                        openpal::Logger* pLogger,
...
ParseResult APDUParser::ParseHeader(RSlice& buffer,
                                    openpal::Logger* pLogger,
                                    uint32_t count,
                                    const ParserSettings& settings,
                                    IAPDUHandler* pHandler,
...
ParseResult APDUParser::ParseQualifier(RSlice& buffer,
                                       openpal::Logger* pLogger,
...
ParseResult APDUParser::HandleAllObjectsHeader(openpal::Logger* pLogger,
                                               const HeaderRecord& record,
                                               const ParserSettings& settings,
                                               IAPDUHandler* pHandler)
{
