...
ParseResult CountIndexParser::ParseHeader(openpal::RSlice& buffer,
                                          ...
                                          IAPDUHandler* pHandler)
{
    ...
    {
        FORMAT_LOGGER_BLOCK(pLogger, settings.Filters(), "%03u,%03u %s, %s [%u]", record.group, record.variation,
...
ParseResult CountIndexParser::ParseIndexPrefixedOctetData(openpal::RSlice& buffer,
                                                          const HeaderRecord& record,
                                                          const NumParser& numparser,
                                                          uint32_t count,
                                                          openpal::Logger* pLogger,
