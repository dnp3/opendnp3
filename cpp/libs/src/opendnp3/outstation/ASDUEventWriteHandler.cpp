...
namespace opendnp3
{
	uint16_t ASDUEventWriteHandler::Write(EventBinaryVariation variation, const DNPTime& first, EventCollection<Binary>& items)
	{
		switch (variation) {
			case(EventBinaryVariation::Group2Var1):			
				return EventWriters::WritePrefixed(this->writer, items, Group2Var1::Inst());
			case(EventBinaryVariation::Group2Var2):			
				return EventWriters::WritePrefixed(this->writer, items, Group2Var2::Inst());				
	...
	uint16_t ASDUEventWriteHandler::Write(EventDoubleBinaryVariation variation, const DNPTime& first, EventCollection<DoubleBitBinary>& items)
	{
		...
		case(EventDoubleBinaryVariation::Group4Var1):
			return EventWriters::WritePrefixed(this->writer, items, Group4Var1::Inst());
		case(EventDoubleBinaryVariation::Group4Var2):
			return EventWriters::WritePrefixed(this->writer, items, Group4Var2::Inst());
	...
	uint16_t ASDUEventWriteHandler::Write(EventCounterVariation variation, const DNPTime& first, EventCollection<Counter>& items)
	{
		...
		case(EventCounterVariation::Group22Var1):
			return EventWriters::WritePrefixed(this->writer, items, Group22Var1::Inst());
		case(EventCounterVariation::Group22Var2):
			return EventWriters::WritePrefixed(this->writer, items, Group22Var2::Inst());
		case(EventCounterVariation::Group22Var5):
			return EventWriters::WritePrefixed(this->writer, items, Group22Var5::Inst());
		case(EventCounterVariation::Group22Var6):		
			return EventWriters::WritePrefixed(this->writer, items, Group22Var6::Inst());			
		default:
			return EventWriters::WritePrefixed(this->writer, items, Group22Var1::Inst());
		}
	}
	...
	uint16_t ASDUEventWriteHandler::Write(EventFrozenCounterVariation variation, const DNPTime& first, EventCollection<FrozenCounter>& items)
	{
		...
		case(EventFrozenCounterVariation::Group23Var1):
			return EventWriters::WritePrefixed(this->writer, items, Group23Var1::Inst());
		case(EventFrozenCounterVariation::Group23Var2):
			return EventWriters::WritePrefixed(this->writer, items, Group23Var2::Inst());
		case(EventFrozenCounterVariation::Group23Var5):
			return EventWriters::WritePrefixed(this->writer, items, Group23Var5::Inst());
		case(EventFrozenCounterVariation::Group23Var6):		
			return EventWriters::WritePrefixed(this->writer, items, Group23Var6::Inst());
		default:
			return 0;
		}
	}
	...
	uint16_t ASDUEventWriteHandler::Write(EventAnalogVariation variation, const DNPTime& first, EventCollection<Analog>& items)
	{
		...
		case(EventAnalogVariation::Group32Var1):
			return EventWriters::WritePrefixed(this->writer, items, Group32Var1::Inst());
		case(EventAnalogVariation::Group32Var2):
			return EventWriters::WritePrefixed(this->writer, items, Group32Var2::Inst());
		case(EventAnalogVariation::Group32Var3):
			return EventWriters::WritePrefixed(this->writer, items, Group32Var3::Inst());
		case(EventAnalogVariation::Group32Var4):
			return EventWriters::WritePrefixed(this->writer, items, Group32Var4::Inst());
		case(EventAnalogVariation::Group32Var5):
			return EventWriters::WritePrefixed(this->writer, items, Group32Var5::Inst());
		case(EventAnalogVariation::Group32Var6):
			return EventWriters::WritePrefixed(this->writer, items, Group32Var6::Inst());
		case(EventAnalogVariation::Group32Var7):
			return EventWriters::WritePrefixed(this->writer, items, Group32Var7::Inst());
		case(EventAnalogVariation::Group32Var8):
			return EventWriters::WritePrefixed(this->writer, items, Group32Var8::Inst());
		default:			
			return EventWriters::WritePrefixed(this->writer, items, Group32Var1::Inst());
		}
	}
	...
	uint16_t ASDUEventWriteHandler::Write(EventBinaryOutputStatusVariation variation, const DNPTime& first, EventCollection<BinaryOutputStatus>& items)
	{
		...
		case(EventBinaryOutputStatusVariation::Group11Var1):
			return EventWriters::WritePrefixed(this->writer, items, Group11Var1::Inst());
		case(EventBinaryOutputStatusVariation::Group11Var2):
			return EventWriters::WritePrefixed(this->writer, items, Group11Var2::Inst());
		default:
			return EventWriters::WritePrefixed(this->writer, items, Group11Var1::Inst());
		}
	}
	...
	uint16_t ASDUEventWriteHandler::Write(EventAnalogOutputStatusVariation variation, const DNPTime& first, EventCollection<AnalogOutputStatus>& items)
	{
		...
		case(EventAnalogOutputStatusVariation::Group42Var1):
			return EventWriters::WritePrefixed(this->writer, items, Group42Var1::Inst());
		case(EventAnalogOutputStatusVariation::Group42Var2):
			return EventWriters::WritePrefixed(this->writer, items, Group42Var2::Inst());
		case(EventAnalogOutputStatusVariation::Group42Var3):
			return EventWriters::WritePrefixed(this->writer, items, Group42Var3::Inst());
		case(EventAnalogOutputStatusVariation::Group42Var4):
			return EventWriters::WritePrefixed(this->writer, items, Group42Var4::Inst());
		case(EventAnalogOutputStatusVariation::Group42Var5):
			return EventWriters::WritePrefixed(this->writer, items, Group42Var5::Inst());
		case(EventAnalogOutputStatusVariation::Group42Var6):
			return EventWriters::WritePrefixed(this->writer, items, Group42Var6::Inst());
		case(EventAnalogOutputStatusVariation::Group42Var7):
			return EventWriters::WritePrefixed(this->writer, items, Group42Var7::Inst());
		case(EventAnalogOutputStatusVariation::Group42Var8):
			return EventWriters::WritePrefixed(this->writer, items, Group42Var8::Inst());
		default:
			return EventWriters::WritePrefixed(this->writer, items, Group42Var1::Inst());
		}
	}
