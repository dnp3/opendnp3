...
std::shared_ptr<IMasterScan> MasterStack::AddScan(openpal::TimeDuration period,
...
void MasterStack::SelectAndOperate(opendnp3::CommandSet&& commands,
...
void MasterStack::DirectOperate(opendnp3::CommandSet&& commands,
                                const opendnp3::CommandCallbackT& callback,
                                const opendnp3::TaskConfig& config)
{
    /// this is to work around the fact that c++11 doesn't have generic move capture
