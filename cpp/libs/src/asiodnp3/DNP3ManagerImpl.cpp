...
std::shared_ptr<asiopal::IListener> DNP3ManagerImpl::CreateListener(std::string loggerid,
                                                                    ...
                                                                    std::error_code& ec)
{
    auto create = [&]() -> std::shared_ptr<asiopal::IListener> {
        return asiodnp3::MasterTCPServer::Create(this->logger.Detach(loggerid, levels),
                                                 asiopal::Executor::Create(this->io), endpoint, callbacks,
                                                 this->resources, ec);
    };
                                                                    ...
                                                                    std::error_code& ec)
{
    ...
    auto create = [&]() -> std::shared_ptr<asiopal::IListener> {
        return asiodnp3::MasterTLSServer::Create(this->logger.Detach(loggerid, levels),
                                                 asiopal::Executor::Create(this->io), endpoint, config, callbacks,
                                                 this->resources, ec);
    };
