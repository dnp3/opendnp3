...
bool Group42Var1::Write(const Group42Var1& arg, openpal::WriteBufferView& buffer)
{
...
bool Group42Var1::WriteTarget(const AnalogOutputStatus& value, openpal::WriteBufferView& buff)
{
...
bool Group42Var2::Write(const Group42Var2& arg, openpal::WriteBufferView& buffer)
{
  return Format::Many(buffer, arg.flags, arg.value);
}
...
bool Group42Var2::WriteTarget(const AnalogOutputStatus& value, openpal::WriteBufferView& buff)
{
...
bool Group42Var3::Write(const Group42Var3& arg, openpal::WriteBufferView& buffer)
{
...
bool Group42Var3::WriteTarget(const AnalogOutputStatus& value, openpal::WriteBufferView& buff)
{
...
bool Group42Var4::Write(const Group42Var4& arg, openpal::WriteBufferView& buffer)
{
  return Format::Many(buffer, arg.flags, arg.value, arg.time);
}
...
bool Group42Var4::WriteTarget(const AnalogOutputStatus& value, openpal::WriteBufferView& buff)
{
...
bool Group42Var5::Write(const Group42Var5& arg, openpal::WriteBufferView& buffer)
{
  return Format::Many(buffer, arg.flags, arg.value);
}
...
bool Group42Var5::WriteTarget(const AnalogOutputStatus& value, openpal::WriteBufferView& buff)
{
...
bool Group42Var6::Write(const Group42Var6& arg, openpal::WriteBufferView& buffer)
{
  return Format::Many(buffer, arg.flags, arg.value);
}
...
bool Group42Var6::WriteTarget(const AnalogOutputStatus& value, openpal::WriteBufferView& buff)
{
...
bool Group42Var7::Write(const Group42Var7& arg, openpal::WriteBufferView& buffer)
{
  return Format::Many(buffer, arg.flags, arg.value, arg.time);
}
...
bool Group42Var7::WriteTarget(const AnalogOutputStatus& value, openpal::WriteBufferView& buff)
{
...
bool Group42Var8::Write(const Group42Var8& arg, openpal::WriteBufferView& buffer)
{
  return Format::Many(buffer, arg.flags, arg.value, arg.time);
}
...
bool Group42Var8::WriteTarget(const AnalogOutputStatus& value, openpal::WriteBufferView& buff)
{
