 ...
 */
#ifndef OPENDNP3_MASTERAUTHWRAPPER_H
#define OPENDNP3_MASTERAUTHWRAPPER_H
...
/**
	Proxies access to an IMasterAuthProvider
*/
class MasterAuthWrapper : private openpal::Uncopyable
{
	public:
