...
namespace opendnp3
{
	...
	WriteTask::WriteTask(const MasterParams& params, const std::string& name_, TaskId id_, ITaskCallback* pCallback_, const std::function<void(HeaderWriter&)> format_, const openpal::Logger& logger) :
