...
namespace opendnp3
{
	...
	/** 
		Configuration information for outstation authentication
	*/
	class OutstationAuthFactory : private openpal::Uncopyable
	{

		static std::unique_ptr<IOutstationAuthProvider> Create()
