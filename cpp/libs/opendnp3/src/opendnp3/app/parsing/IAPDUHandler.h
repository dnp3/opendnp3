...
public:
	...
	void OnHeader(const FreeFormatHeader& header, const Group120Var7& value);
	void OnHeader(const FreeFormatHeader& header, const Group120Var10& value);
...
protected:
	...
	virtual IINField ProcessHeader(const FreeFormatHeader& header, const Group120Var7& value);
	virtual IINField ProcessHeader(const FreeFormatHeader& header, const Group120Var10& value);
