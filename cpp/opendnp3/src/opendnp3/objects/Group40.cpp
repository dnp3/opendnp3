...
SetpointStatus Group40Var1Serializer::Read(ReadOnlyBuffer& buff) const
{
  auto gv = Group40Var1::Read(buff);
  return SetpointStatusFactory::From(gv.flags, gv.value);
}

void Group40Var1Serializer::Write(const SetpointStatus& value, openpal::WriteBuffer& buff) const
{
...
SetpointStatus Group40Var2Serializer::Read(ReadOnlyBuffer& buff) const
{
  auto gv = Group40Var2::Read(buff);
  return SetpointStatusFactory::From(gv.flags, gv.value);
}

void Group40Var2Serializer::Write(const SetpointStatus& value, openpal::WriteBuffer& buff) const
{
...
SetpointStatus Group40Var3Serializer::Read(ReadOnlyBuffer& buff) const
{
  auto gv = Group40Var3::Read(buff);
  return SetpointStatusFactory::From(gv.flags, gv.value);
}

void Group40Var3Serializer::Write(const SetpointStatus& value, openpal::WriteBuffer& buff) const
{
...
SetpointStatus Group40Var4Serializer::Read(ReadOnlyBuffer& buff) const
{
  auto gv = Group40Var4::Read(buff);
  return SetpointStatusFactory::From(gv.flags, gv.value);
}

void Group40Var4Serializer::Write(const SetpointStatus& value, openpal::WriteBuffer& buff) const
{
