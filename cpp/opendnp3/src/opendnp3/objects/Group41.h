...
struct Group41Var1Serializer : public IDNP3Serializer<AnalogOutputInt32>
{
	...
	static IDNP3Serializer<AnalogOutputInt32>* Inst()
	{
		return &mInstance;
	}
	...
	{
		return Group41Var1::ID;
	}

	uint32_t Size() const
	{
		return Group41Var1::SIZE;
	}
...
struct Group41Var2Serializer : public IDNP3Serializer<AnalogOutputInt16>
{
	...
	static IDNP3Serializer<AnalogOutputInt16>* Inst()
	{
		return &mInstance;
	}
	...
	GroupVariationID ID() const
	{
		return Group41Var2::ID;
	}

	uint32_t Size() const
	{
		return Group41Var2::SIZE;
	}
...
struct Group41Var3Serializer : public IDNP3Serializer<AnalogOutputFloat32>
{
	...
	static IDNP3Serializer<AnalogOutputFloat32>* Inst()
	{
		return &mInstance;
	}
	...
	GroupVariationID ID() const
	{
		return Group41Var3::ID;
	}

	uint32_t Size() const
	{
		return Group41Var3::SIZE;
	}
...
struct Group41Var4Serializer : public IDNP3Serializer<AnalogOutputDouble64>
{
	...
	static IDNP3Serializer<AnalogOutputDouble64>* Inst()
	{
		return &mInstance;
	}
	...
	GroupVariationID ID() const
	{
		return Group41Var4::ID;
	}

	uint32_t Size() const
	{
		return Group41Var4::SIZE;
	}
