...
struct Group2Var1Serializer : public IDNP3Serializer<Binary>
{
	...
	static IDNP3Serializer<Binary>* Inst()
	{
		return &mInstance;
	}
	...
	{
		return Group2Var1::ID;
	}

	uint32_t Size() const
	{
		return Group2Var1::SIZE;
	}
...
struct Group2Var2Serializer : public IDNP3Serializer<Binary>
{
	...
	GroupVariationID ID() const
	{
		return Group2Var2::ID;
	}

	uint32_t Size() const
	{
		return Group2Var2::SIZE;
	}
...
struct Group2Var3Serializer : public IDNP3Serializer<Binary>
{
	...
	GroupVariationID ID() const
	{
		return Group2Var3::ID;
	}

	uint32_t Size() const
	{
		return Group2Var3::SIZE;
	}
