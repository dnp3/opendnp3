...
struct Group22Var1Serializer : public IDNP3Serializer<Counter>
{
	...
	{
		return Group22Var1::ID;
	}

	uint32_t Size() const
	{
		return Group22Var1::SIZE;
	}
...
struct Group22Var2Serializer : public IDNP3Serializer<Counter>
{
	...
	GroupVariationID ID() const
	{
		return Group22Var2::ID;
	}

	uint32_t Size() const
	{
		return Group22Var2::SIZE;
	}
...
struct Group22Var5Serializer : public IDNP3Serializer<Counter>
{
	...
	GroupVariationID ID() const
	{
		return Group22Var5::ID;
	}

	uint32_t Size() const
	{
		return Group22Var5::SIZE;
	}
...
struct Group22Var6Serializer : public IDNP3Serializer<Counter>
{
	...
	GroupVariationID ID() const
	{
		return Group22Var6::ID;
	}

	uint32_t Size() const
	{
		return Group22Var6::SIZE;
	}
