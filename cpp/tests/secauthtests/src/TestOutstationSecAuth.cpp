...
TEST_CASE(SUITE("ReadSecurityStatEvents"))
{
	...
	fixture.SendToOutstation(hex::EventPoll(seq.Get(), ClassField::AllEventClasses()));
	REQUIRE(fixture.lower.PopWriteAsHex() == "E3 81 80 00 7A 01 28 01 00 06 00 01 00 00 64 00 00 00"); // total rx == 100
	fixture.OnSendResult(true);
	...
	fixture.SendToOutstation(hex::EventPoll(seq.Get(), ClassField::AllEventClasses()));
	REQUIRE(fixture.lower.PopWriteAsHex() == "E4 81 80 00 7A 01 28 01 00 05 00 01 00 00 64 00 00 00"); // total tx == 100
}