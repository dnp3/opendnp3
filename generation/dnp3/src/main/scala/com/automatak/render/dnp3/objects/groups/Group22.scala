...
object Group22Var3 extends FixedSize(Group22, 3)(flags, count32) with ConversionToCounter // delta
object Group22Var4 extends FixedSize(Group22, 4)(flags, count16) with ConversionToCounter // delta
...
object Group22Var7 extends FixedSize(Group22, 7)(flags, count32, time48) with ConversionToCounter // delta
object Group22Var8 extends FixedSize(Group22, 8)(flags, count16, time48) with ConversionToCounter // delta
