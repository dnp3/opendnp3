...
namespace Automatak
{
	namespace DNP3
	{
		namespace Adapter
		{
			...
			void SOEHandlerAdapter::OnReceiveHeader(const opendnp3::HeaderRecord& header, opendnp3::TimestampMode tsmode, const opendnp3::IterableBuffer<opendnp3::IndexedValue<opendnp3::BinaryCommandEvent, uint16_t>>& meas)
			{
