	...
	namespace DNP3
	{
		namespace Adapter
		{
			...
			public:
				...
				virtual IChannel^ AddTCPServer(System::String^ id, System::UInt32 filters, System::String^ endpoint, System::UInt16 port, Interface::IChannelListener^ listener) sealed;
				...
				virtual IChannel^ AddTLSServer(System::String^ id, System::UInt32 filters, System::String^ endpoint, System::UInt16 port, Interface::TLSConfig^ config, Interface::IChannelListener^ listener) sealed;
