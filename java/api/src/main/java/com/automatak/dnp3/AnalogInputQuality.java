...
public enum AnalogInputQuality implements QualityField {
    ...
    public static List<AnalogInputQuality> getValuesInBitField(byte bitfield)
    {
        List<AnalogInputQuality> list = new ArrayList<AnalogInputQuality>();
        ...
        if((bitfield & OVERRANGE.toByte()) != 0) list.add(OVERRANGE);
        if((bitfield & REFERENCE_CHECK.toByte()) != 0) list.add(REFERENCE_CHECK);
