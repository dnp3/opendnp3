 ...
 * Signature: (JLjava/lang/String;ILjava/lang/String;ILcom/automatak/dnp3/ChannelListener;)J
 */
JNIEXPORT jlong JNICALL Java_com_automatak_dnp3_impl_ManagerImpl_get_1native_1channel_1tcp_1server
  (JNIEnv *, jobject, jlong, jstring, jint, jstring, jint, jobject);
 ...
 * Signature: (JLjava/lang/String;ILjava/lang/String;ILcom/automatak/dnp3/TLSConfig;Lcom/automatak/dnp3/ChannelListener;)J
 */
JNIEXPORT jlong JNICALL Java_com_automatak_dnp3_impl_ManagerImpl_get_1native_1channel_1tls_1server
  (JNIEnv *, jobject, jlong, jstring, jint, jstring, jint, jobject, jobject);
