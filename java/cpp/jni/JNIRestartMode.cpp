...
namespace jni
{
    namespace cache
    {
        bool RestartMode::init(JNIEnv* env)
        {
            ...
            this->method0 = env->GetStaticMethodID(this->clazz, "fromType", "(I)Lcom/automatak/dnp3/enums/RestartMode;");
        ...
        LocalRef<JRestartMode> RestartMode::fromType(JNIEnv* env, jint arg0)
        {
            return LocalRef<JRestartMode>(env, env->CallStaticObjectMethod(this->clazz, this->method0, arg0));
        }

        jint RestartMode::toType(JNIEnv* env, JRestartMode instance)
        {
