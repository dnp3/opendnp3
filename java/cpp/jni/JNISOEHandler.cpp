...
namespace jni
{
    namespace cache
    {
        bool SOEHandler::init(JNIEnv* env)
        {
            ...
            this->processTimeMethod = env->GetMethodID(this->clazz, "processTime", "(Lcom/automatak/dnp3/HeaderInfo;Ljava/lang/Iterable;)V");
            if(!this->processTimeMethod) return false;
        ...
        void SOEHandler::processTime(JNIEnv* env, jobject instance, jobject arg0, jobject arg1)
        {
            env->CallVoidMethod(instance, this->processTimeMethod, arg0, arg1);
        }
