...
namespace jni
{
    namespace cache
    {
        bool GroupVariation::init(JNIEnv* env)
        {
            ...
            this->method0 = env->GetStaticMethodID(this->clazz, "fromType", "(I)Lcom/automatak/dnp3/enums/GroupVariation;");
        ...
        LocalRef<JGroupVariation> GroupVariation::fromType(JNIEnv* env, jint arg0)
        {
            return LocalRef<JGroupVariation>(env, env->CallStaticObjectMethod(this->clazz, this->method0, arg0));
        }

        jint GroupVariation::toType(JNIEnv* env, JGroupVariation instance)
        {
