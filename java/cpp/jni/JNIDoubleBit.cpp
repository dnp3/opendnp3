...
namespace jni
{
    namespace cache
    {
        bool DoubleBit::init(JNIEnv* env)
        {
            ...
            this->method0 = env->GetStaticMethodID(this->clazz, "fromType", "(I)Lcom/automatak/dnp3/enums/DoubleBit;");
        ...
        LocalRef<JDoubleBit> DoubleBit::fromType(JNIEnv* env, jint arg0)
        {
            return LocalRef<JDoubleBit>(env, env->CallStaticObjectMethod(this->clazz, this->method0, arg0));
        }

        jint DoubleBit::toType(JNIEnv* env, JDoubleBit instance)
        {
