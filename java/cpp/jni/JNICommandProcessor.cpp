...
namespace jni
{
    namespace cache
    {
        ...
        jobject CommandProcessor::selectAndOperateAOInt16(JNIEnv* env, jobject instance, jobject arg0, jint arg1)
        {
        ...
        {
            return env->CallObjectMethod(instance, this->directOperateAOFloat32Method, arg0, arg1);
        }
