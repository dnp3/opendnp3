...
namespace jni
{
    namespace cache
    {
        bool OperateType::init(JNIEnv* env)
        {
            ...
            this->method0 = env->GetStaticMethodID(this->clazz, "fromType", "(I)Lcom/automatak/dnp3/enums/OperateType;");
        ...
        LocalRef<JOperateType> OperateType::fromType(JNIEnv* env, jint arg0)
        {
            return LocalRef<JOperateType>(env, env->CallStaticObjectMethod(this->clazz, this->method0, arg0));
        }

        jint OperateType::toType(JNIEnv* env, JOperateType instance)
        {
