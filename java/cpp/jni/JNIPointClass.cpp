...
namespace jni
{
    namespace cache
    {
        bool PointClass::init(JNIEnv* env)
        {
            ...
            this->method0 = env->GetStaticMethodID(this->clazz, "fromType", "(I)Lcom/automatak/dnp3/enums/PointClass;");
        ...
        LocalRef<JPointClass> PointClass::fromType(JNIEnv* env, jint arg0)
        {
            return LocalRef<JPointClass>(env, env->CallStaticObjectMethod(this->clazz, this->method0, arg0));
        }

        jint PointClass::toType(JNIEnv* env, JPointClass instance)
        {
