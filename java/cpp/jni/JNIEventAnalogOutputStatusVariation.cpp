...
namespace jni
{
    namespace cache
    {
        bool EventAnalogOutputStatusVariation::init(JNIEnv* env)
        {
            ...
            this->fromTypeMethod = env->GetStaticMethodID(this->clazz, "fromType", "(I)Lcom/automatak/dnp3/enums/EventAnalogOutputStatusVariation;");
        ...
        LocalRef<jobject> EventAnalogOutputStatusVariation::fromType(JNIEnv* env, jint arg0)
        {
            return LocalRef<jobject>(env, env->CallStaticObjectMethod(this->clazz, this->fromTypeMethod, arg0));
        }

        jint EventAnalogOutputStatusVariation::toType(JNIEnv* env, jobject instance)
        {
