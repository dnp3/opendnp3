...
namespace jni
{
    ...
    namespace cache
    {
        class TLSConfig
        {
            ...
            jstring getpeerCertFilePath(JNIEnv* env, jobject instance);
            jstring getlocalCertFilePath(JNIEnv* env, jobject instance);
            jstring getprivateKeyFilePath(JNIEnv* env, jobject instance);
            ...
            jstring getcipherList(JNIEnv* env, jobject instance);
