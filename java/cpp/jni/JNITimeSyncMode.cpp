...
namespace jni
{
    namespace cache
    {
        bool TimeSyncMode::init(JNIEnv* env)
        {
            ...
            this->method0 = env->GetStaticMethodID(this->clazz, "fromType", "(I)Lcom/automatak/dnp3/enums/TimeSyncMode;");
        ...
        LocalRef<JTimeSyncMode> TimeSyncMode::fromType(JNIEnv* env, jint arg0)
        {
            return LocalRef<JTimeSyncMode>(env, env->CallStaticObjectMethod(this->clazz, this->method0, arg0));
        }

        jint TimeSyncMode::toType(JNIEnv* env, JTimeSyncMode instance)
        {
