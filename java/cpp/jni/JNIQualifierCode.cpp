...
namespace jni
{
    bool QualifierCode::init(JNIEnv* env)
    {
        ...
        this->clazz = env->FindClass("Lcom/automatak/dnp3/enums/QualifierCode;");
        if(!this->clazz) return false;

        this->fromTypeMethod = env->GetMethodID(this->clazz, "fromType", "(I)Lcom/automatak/dnp3/enums/QualifierCode;");
