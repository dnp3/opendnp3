...
public interface DNP3Manager {
     ...
     * @throws DNP3Exception if an error occurs creating the channel
     */
    Channel addTCPServer(String id, int levels, String endpoint, int port, ChannelListener listener) throws DNP3Exception;
     ...
     * @throws DNP3Exception if an error occurs creating the channel
     */
    Channel addTLSServer(String id, int levels, String endpoint, int port, TLSConfig config, ChannelListener listener) throws DNP3Exception;
